...
type Pet struct {
	...
	Foo float32 `protobuf:"fixed32,1,opt,name=foo,proto3" json:"foo,omitempty"`
}
...
var file_pet_v1_pet_proto_rawDesc = []byte{
	...
	0x23, 0x0a, 0x03, 0x50, 0x65, 0x74, 0x12, 0x1c, 0x0a, 0x03, 0x66, 0x6f, 0x6f, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x02, 0x42, 0x0a, 0xfa, 0x42, 0x07, 0x0a, 0x05, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x52,
	0x03, 0x66, 0x6f, 0x6f, 0x22, 0x2f, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x50, 0x65, 0x74, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1e, 0x0a, 0x06, 0x70, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x28, 0x03, 0x52, 0x05,
	...
	0x72, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x70, 0x65, 0x74, 0x2f, 0x76, 0x31, 0x3b, 0x70, 0x65, 0x74,
...
var file_pet_v1_pet_proto_depIdxs = []int32{
	1, // 0: pet.v1.GetPetResponse.pet:type_name -> pet.v1.Pet
	0, // 1: pet.v1.PutPetRequest.pet_type:type_name -> pet.v1.PetType
	1, // 2: pet.v1.PutPetResponse.pet:type_name -> pet.v1.Pet
	2, // 3: pet.v1.PetStoreService.GetPet:input_type -> pet.v1.GetPetRequest
	4, // 4: pet.v1.PetStoreService.PutPet:input_type -> pet.v1.PutPetRequest
	6, // 5: pet.v1.PetStoreService.DeletePet:input_type -> pet.v1.DeletePetRequest
	3, // 6: pet.v1.PetStoreService.GetPet:output_type -> pet.v1.GetPetResponse
	5, // 7: pet.v1.PetStoreService.PutPet:output_type -> pet.v1.PutPetResponse
	7, // 8: pet.v1.PetStoreService.DeletePet:output_type -> pet.v1.DeletePetResponse
